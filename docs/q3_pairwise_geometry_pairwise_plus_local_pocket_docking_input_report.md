...
- backend_candidate_json: `checkpoints/q3_pairwise_geometry_public100/pairwise_plus_local_pocket/docking_inputs/candidates_pairwise_plus_local_pocket.json`
