...
- backend_candidate_json: `checkpoints/q3_pairwise_geometry_public100/pairwise_distance_direction/docking_inputs/candidates_pairwise_distance_direction.json`
